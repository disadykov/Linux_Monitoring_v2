...
Bash-скрипты тестировались в ОС **`Ubuntu desktop 22.04`**
...
Написать bash-скрипт, которая собирает информацию по базовым метрикам системы (ЦПУ, оперативная память, жесткий диск (объем)).
